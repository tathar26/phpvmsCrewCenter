...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo SITE_URL?>/lib/skins/iCrewLITE/css/bootstrap-select.min.css">

    <!-- Latest compiled and minified JavaScript -->
    <script src="<?php echo SITE_URL?>/lib/skins/iCrewLITE/js/bootstrap-select.min.js"></script>

    <!-- (Optional) Latest compiled and minified JavaScript translation files -->
    

    <!--Your Google Maps API Key here-->
    <script src="https://maps.google.com/maps/api/js?v=3&libraries=geometry&language=en_gr&key=AIzaSyBNCyEkzfDHcfWEIIXOuF-phgZ-X77rSG0" type="text/javascript"></script>
